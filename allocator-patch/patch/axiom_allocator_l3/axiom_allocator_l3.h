 ...
 */
typedef void (*aal3_register_t)(axiom_al3_info_t*);
void axiom_al3sw_register(aal3_register_t aal3_register);
void axiom_al3hw_register(aal3_register_t aal3_register);
